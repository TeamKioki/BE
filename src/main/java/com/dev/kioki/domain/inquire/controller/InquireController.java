...
public class InquireController {
    ...
    public BaseResponse<InquireResponseDTO.CreateInqireResultDTO> createInquire(@RequestBody @Valid InquireRequestDTO.InquireDTO request,
                                                                                @AuthUser User user) {
        Inquire inquire = inquireCommandService.createInquire(user.getId(), request);
